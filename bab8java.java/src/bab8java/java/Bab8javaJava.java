...
//         int jumlahKelas = Integer.parseInt(JOptionPane.showInputDialog(null,
//            "Masukkan jumlah kelas:", "Input", JOptionPane.INFORMATION_MESSAGE));
//
//        String[][] isiKelas = new String[jumlahKelas][];
//
//        for (int kelas = 0; kelas < jumlahKelas; kelas++) {
//            String namaKelas = JOptionPane.showInputDialog(null,
//                "Nama Kelas:", "Masukkan Nama Kelas", JOptionPane.INFORMATION_MESSAGE);
//
//            int jumlahKursi = Integer.parseInt(JOptionPane.showInputDialog(null,
//                "Jumlah murid masing-masing kelas:", "Input", JOptionPane.INFORMATION_MESSAGE));
//
...
//                    "Nama Siswa ke-" + (kursi + 1), "Kelas " + namaKelas,
